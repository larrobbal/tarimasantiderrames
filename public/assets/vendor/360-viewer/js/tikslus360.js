...
context.fillText('Cargando:'+(i-1)+"/"+options.imageCount, 150, 100);
 ...
 //view360.css({width:options.canvasWidth + "px",height:options.canvasHeight + "px"});
...
let v360 = $('#botesPilas').tikslus360({imageDir:'assets/vendor/360-viewer/images/botes-pilas',imageCount:26,imageExt:'webp',canvasID:'botesPila',canvasWidth:450,canvasHeight:628,autoRotate:true});